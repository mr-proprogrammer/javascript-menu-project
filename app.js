...
//! dom content loader ends here

// * display menu

function displayMenuItems(mainMenu) {
...
function displayFilterButtons() {
  ...
  // wrap categories in the html to display the buttons on screen
  ...
  // select all the buttons iterate over the buttons attach an event listener and then filter the menu items.
